...
class Retina(object):
    ...
    def PSTupdate(self,trial,stim,tsim,binsize,type,retina):
        ...
        # to save spikes
        #os.system("mkdir "+root_path+"results/retina/"+type+"/stim{:.1f}".format(stim))
        os.system("mkdir "+root_path+"results/retina/"+type+"/stim{:.1f}".format(stim))
        text_file = open(root_path+"results/retina/"+type+"/stim{:.1f}".format(stim)+"/spikes"+str(trial), "w")
    ...
    def savePST(self,stim,type):
        ...
        text_file = open(root_path+"results/retina/"+type+"/stim{:.1f}".format(stim)+"/PST", "w")
    ...
    def loadPST(self,stim,N,tsim,binsize,type):
        ...
        lines = [line.rstrip('\n') for line in open(root_path+"results/retina/"+type+"/stim{:.1f}".format(stim)+"/PST", "r")]
    ...
    def loadSpikes(self,stim,trial,N,type):
        ...
        lines = [line.rstrip('\n') for line in open(root_path+"results/retina/"+type+"/stim{:.1f}".format(stim)+"/spikes"+str(trial), "r")]
